package ch05;// == ch05.SequenceFileSeekAndSyncTest
// == ch05.SequenceFileSeekAndSyncTest-SeekNonRecordBoundary
// == ch05.SequenceFileSeekAndSyncTest-SyncNonRecordBoundary
...
import ch05.SequenceFileWriteDemo;
...
public class SequenceFileSeekAndSyncTest {
  ...
  public void seekToRecordBoundary() throws IOException {
    // vv ch05.SequenceFileSeekAndSyncTest
    reader.seek(359);
    assertThat(reader.next(key, value), is(true));
    assertThat(((IntWritable) key).get(), is(95));
    // ^^ ch05.SequenceFileSeekAndSyncTest
  }
  
  @Test(expected=IOException.class)
  public void seekToNonRecordBoundary() throws IOException {
    // vv ch05.SequenceFileSeekAndSyncTest-SeekNonRecordBoundary
    reader.seek(360);
  ...
  public void syncFromNonRecordBoundary() throws IOException {
    // vv ch05.SequenceFileSeekAndSyncTest-SyncNonRecordBoundary
    reader.sync(360);
