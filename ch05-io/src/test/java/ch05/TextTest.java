package ch05;// == ch05.TextTest
// == ch05.TextTest-Find
// == ch05.TextTest-Mutability
// == ch05.TextTest-ByteArrayNotShortened
// == ch05.TextTest-ToString
// == ch05.TextTest-Comparison
...
public class TextTest extends WritableTestBase {
  ...
  public void byteArrayNotShortened() throws IOException {
    // vv ch05.TextTest-ByteArrayNotShortened
    Text t = new Text("hadoop");
    t.set(/*[*/new Text("pig")/*]*/);
    assertThat(t.getLength(), is(3));
