package ch02;// cc ch02.OldMaxTemperature Application to find the maximum temperature, using the old MapReduce API
...
public class OldMaxTemperature {
  ...
  public static void main(String[] args) throws IOException {
    if (args.length != 2) {
      System.err.println("Usage: ch02.OldMaxTemperature <input path> <output path>");
      System.exit(-1);
    }
