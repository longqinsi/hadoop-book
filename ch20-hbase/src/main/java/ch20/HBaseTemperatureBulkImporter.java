...
public class HBaseTemperatureBulkImporter extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    if (args.length != 1) {
      System.err.println("Usage: ch20.HBaseTemperatureBulkImporter <input>");
      return -1;
    }
    ...
    try {
      ...
      loader.doBulkLoad(tmpPath, connection.getAdmin(), table, connection.getRegionLocator(tableName));
